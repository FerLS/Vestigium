...
class Light(pygame.sprite.Sprite):
    ...
    def draw(self, screen, offset=(0, 0)):
        ...
        if self.mask:
            ...
            screen.blit(mask_surface, (draw_position.x - self.distance - offset_x, draw_position.y - self.distance - offset_y))
...
class ConeLight(Light):
    def __init__(self, position, direction, angle, distance, segments=60, ray_step=2, fixed_position=None):
